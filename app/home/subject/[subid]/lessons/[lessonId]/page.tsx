...
export default function LessonDetailsTabs() {
  ...
  // Handle sending a new discussion message.
  // Limit: user can only create up to 2 discussion messages per lesson.
                            ...
                            replies[msg.id].map((reply) => (
                              ...
                              >
                                ...
                                {reply.user_id === userData?.id && (
                                  <IconButton
                                    onClick={() => handleDeleteReply(reply.id, reply.user_id, msg.id)}
                                    color="error"
                                    size="small"
                                  >
                                    <DeleteIcon />
